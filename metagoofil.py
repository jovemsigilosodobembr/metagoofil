...
def usage():
    ...
    print "         -d: domínio para pesquisar"
    print "         -t: tipo de arquivo para baixar (pdf,doc,xls,ppt,odp,ods,docx,xlsx,pptx)"
    print "         -l: limite de resultados para pesquisar (default 200)"
